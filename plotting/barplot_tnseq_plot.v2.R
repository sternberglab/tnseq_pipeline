...
##to execute: 
##Rscript --vanilla plotting/barplot_tnseq_plot.R output_log.csv ~/output_directory/
...
Other <- output_csv$Filtered.Reads - (output_csv$Unique.Genome.Mapping.Reads + output_csv$Contaminating.donor.reads)
Sample<-output_csv$Sample
Unique_genome_insertion_reads<-output_csv$Unique.Genome.Mapping.Reads
Contaminating_donor_reads<-output_csv$Contaminating.donor.reads
